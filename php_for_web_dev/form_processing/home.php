	...
	<div class="container">
		...
		<form action="home.php" method="post" class="form-horizontal">
			<div class="form-group has-success">
				...
				<div class="col-sm-6">
					<input class="form-control" type="text" name="first_name" id="first_name" placeholder="Enter your First Name" value="<?php displayInputValue('first_name'); ?>">
					<span style="color: red;"><?php displayErrorMessage("first_name"); ?></span>
				</div>
			</div>
			<div class="form-group has-success">
				<label class="control-label col-sm-2" for="last_name">Last Name</label>
				<div class="col-sm-6">
					<input class="form-control" type="text" name="last_name" id="last_name" placeholder="Enter your Last Name" value="<?php displayInputValue('last_name'); ?>">
					<span style="color: red;"><?php displayErrorMessage("last_name"); ?></span>
				</div>
			</div>
			<div class="form-group has-success">
				<label class="control-label col-sm-2" for="email">Email</label>
				<div class="col-sm-6">
					<input class="form-control" type="email" name="email" id="email" placeholder="Enter your Email" value="<?php displayInputValue('email'); ?>">
					<span style="color: red;"><?php displayErrorMessage("email"); ?></span>
				</div>
			</div>
			<div class="form-group has-success">
